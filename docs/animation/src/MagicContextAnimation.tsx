...
const SCENE_3_START = SCENE_2_START + SCENE_2_DURATION; // 360
const SCENE_4_START = SCENE_3_START + SCENE_3_DURATION; // 690
const SCENE_5_START = SCENE_4_START + SCENE_4_DURATION; // 870
const SCENE_6_START = SCENE_5_START + SCENE_5_DURATION; // 1110
const SCENE_7_START = SCENE_6_START + SCENE_6_DURATION; // 1230
// Total: 1350 frames (45s @ 30fps)
